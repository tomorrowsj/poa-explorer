defmodule Explorer.InternalTransactionTest do
  ...
  describe "changeset/2" do
    test "with valid attributes" do
      ...
      changeset = InternalTransaction.changeset(%InternalTransaction{}, %{transaction_id: transaction.id, index: 0, call_type: "call", trace_address: [0, 1], value: 100, gas: 100, gas_used: 100, input: "pintos", output: "refried"})
